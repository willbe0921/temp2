...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/Jsp_BBS/WebContent/bbslist.jsp">

<h3 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/Jsp_BBS/WebContent/bbslist.jsp">환영합니다<%=mem.getName() %>님 반갑습니다.</h3>
