...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-6" data-genuitec-path="/Jsp_BBS/WebContent/bbswriteAf.jsp">
...
%>
	...
	<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-6" data-genuitec-path="/Jsp_BBS/WebContent/bbswriteAf.jsp">
		alert("글 입력 성공");
