...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-17" data-genuitec-path="/Jsp_BBS/WebContent/pdsupload.jsp">
...
if(isS){
%>
	<script type="text/javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-17" data-genuitec-path="/Jsp_BBS/WebContent/pdsupload.jsp">
	alert("성공");
