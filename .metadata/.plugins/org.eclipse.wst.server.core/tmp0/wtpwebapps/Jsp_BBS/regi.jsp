...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-19" data-genuitec-path="/Jsp_BBS/WebContent/regi.jsp">

<!-- 넘기기 전에 아이디나 이름이 올바른 지 판단해야 함. 자바가 아니라 자바스크립트로 작성 -->

<h1 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-19" data-genuitec-path="/Jsp_BBS/WebContent/regi.jsp">회원등록</h1>
<p>환영합니다</p>
